...
define('css/css-builder',['require', './normalize'], function(req, normalize) {
...
define('lessc-server',['./lessc'], function(less) {
...
define('less',['css', 'require'], function(css, require) {
...
requirejs.s.contexts._.nextTick = function(f){f()}; require(['css'], function(css) { css.addBuffer('../css/main.less'); }); requirejs.s.contexts._.nextTick = requirejs.nextTick;
/*
...
requirejs.s.contexts._.nextTick = function(f){f()}; require(['css'], function(css) { css.setBuffer('.notifications {\n  border: 1px solid #F00;\n}\n', true); }); requirejs.s.contexts._.nextTick = requirejs.nextTick; 
require(["main.build"]);
